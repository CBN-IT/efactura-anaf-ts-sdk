 ...
 */
export function formatDateForAnaf(date) {
 ...
 */
export function getCurrentDateForAnaf() {
 ...
 */
export function isValidAnafDateFormat(dateString) {
 ...
 */
export function isValidDaysParameter(days) {
