 ...
 */
export const getBasePath = (authMode = 'oauth', testMode = false) => {
    if (authMode === 'cert') {
 ...
 */
export const buildUploadParams = (vatNumber, options = {}) => {
 ...
 */
export const buildStatusParams = (uploadId) => {
    const params = new URLSearchParams();
 ...
 */
export const buildDownloadParams = (downloadId) => {
    const params = new URLSearchParams();
 ...
 */
export const buildListMessagesParams = (vatNumber, days, filter) => {
    const params = new URLSearchParams();
    params.append('cif', vatNumber);
 ...
 */
export const buildPaginatedMessagesParams = (vatNumber, startTime, endTime, page, filter) => {
    const params = new URLSearchParams();
    params.append('cif', vatNumber);
