...
exports.AnafDetailsClient = void 0;
...
class AnafDetailsClient {
    ...
    async batchGetCompanyData(vatCodes) {
        ...
        const { data, error } = await (0, tryCatch_1.tryCatch)(this.httpClient.post(this.config.url, validatedPayload, {
            headers: {
        ...
        if (error) {
            ...
            if (error instanceof errors_1.AnafNotFoundError) {
                return {
                    success: false,
...
exports.AnafDetailsClient = AnafDetailsClient;
